...
class Options():
    ...
    def __init__(self, test=False):
        ...
        parser.add_argument('--load', '-l', type=str, default='io/models/quickdraw/checkpoint.pth', help='path to the model to retrain')
        ...
        parser.add_argument('--embedding_number', type=int, default=300,
