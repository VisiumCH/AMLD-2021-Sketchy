...
class Options:
    def __init__(self, test=False):
        ...
        parser.add_argument(
            "--batch_size", "-b", type=int, default=10, help="Batch size."
        )
        parser.add_argument(
            "--learning_rate",
            "-lr",
        ...
        parser.add_argument(
            "--early_stop", "-es", type=int, default=10, help="Early stopping epochs."
        )
        # Acceleration
        parser.add_argument(
        ...
        # Tensorboard
        parser.add_argument(
            "--attn", action="store_false", help="Attention module (Default: True)."
        )
        parser.add_argument(
            "--attn_number",
            type=int,
