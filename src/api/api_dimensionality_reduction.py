...
from src.constants import TENSORBOARD_CLASSES, TENSORBOARD_EMBEDDINGS, TENSORBOARD_IMAGE, CUSTOM_SKETCH_CLASS
...
class DimensionalityReduction():
    ...
    def get_closest_image(self, json_data):
        df = self.projected_embeddings[json_data["reduction_algo"]][str(json_data["nb_dim"])]
